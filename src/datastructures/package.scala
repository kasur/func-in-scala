...
package object datastructures {
  ...
  object Tree {
    // Exercise 3_25 - implement size of the tree
    def size[A](tree: Tree[A]): Int = tree match {
      case Leaf(_) => 1
      case Branch(l,r) => 1 + size(l) + size(r)
    }

    // Exercise 3_26 - implement fin max element of the tree
    ...
    // Exercise 3_28 - implement map function for this ADT structure
